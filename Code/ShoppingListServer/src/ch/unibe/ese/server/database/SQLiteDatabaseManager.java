...
public class SQLiteDatabaseManager {
	...
	private long getServerListId(int userId, long listId) {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(selectEntryifExists);
			if(rs.next()) {
				System.out.println("\tShared List " + rs.getInt(COLUMN_SERVER_LIST_ID) + " does exist in Database");
			} else {
				...
				System.out.println("\tShared List " + rs.getInt(COLUMN_SERVER_LIST_ID) + " is a new server list ID");
			}
